...
async def handle_search_payment_methods(
    ...
    This tool finds and returns all the payment methods associated with the
    user's account that match the merchant's accepted payment methods.
