...
class A2aMessageBuilder:
    ...
    def add_data(self, key: str, data: str | dict[str, Any]) -> Self:
        ...
        If a key is provided, then the data part must be a string.
        The DataPart's data dictionary will be set to { key: data}.
        ...
        Args:
          ...
          data: The data to accompany the key, if provided.  Otherwise,
          the data to be set within the DataPart object.
